...
> Encrypted secrets vault for apps

[![PyPI version](https://badge.fury.io/py/py-vault.svg)](https://pypi.org/project/py-vault/)
...
result = vault("Hello World")

# Example 2: Batch processing
from py_vault import batch
